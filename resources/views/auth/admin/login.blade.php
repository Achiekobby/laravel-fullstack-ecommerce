        ...
        <div class="account-content">
            <div class="login-wrapper">
                <div class="login-content">
                    <form class="login-userset" method="POST" action="{{ route('admin.authenticate') }}">
                        @csrf
                        ...
                        <div class="form-login">
                            <a href="{{route('home.index')}}" class="btn btn-login" style="background: #445A65; border:none;">Go Back</a href="{{route('home.index')}}">
                        </div>
                    </form>
