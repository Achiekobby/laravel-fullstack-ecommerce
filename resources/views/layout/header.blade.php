                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        <ul>
                            ...
                            <li><i class="fi-rs-key"></i><a href="">{{Auth::guard('user')->user()->first_name}} {{Auth::guard('user')->user()->last_name}}</a>  /
                                <form action="{{route('user.logout')}}" method="POST">
                                    @csrf
                                    <a href="{{route('user.logout')}}" onclick="event.preventDefault(); this.closest('form').submit();" >Logout</a>
                                </form>
                            @else
                            <li><i class="fi-rs-key"></i><a href="{{route('login')}}">Log In </a>  / <a href="{{route('guest.register')}}">Sign Up</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.php">
                                    <img class="svg')}}Inject" alt="Surfside Media" src="{{asset('assets/imgs/theme/icons/icon-heart.svg')}}">
