    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                ...
                <h6>Create Edit Product Sub-Category</h6>
            </div>
        </div>

        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.subcategory.update', ['id' => $subcategory->id]) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    <option value="{{ $subcategory->category()->id }}">
                                        {{ $subcategory->category()->category_name }}</option>
