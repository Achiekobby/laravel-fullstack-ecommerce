...
@section('content')
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    ...
                    @foreach ($categories as $category)
                        <div class="card-1 d-flex flex-column justify-content-between" style="height:250px;">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img style="width: 100%;"
                                        src="{{ asset('/uploads/categories/' . $category->image) }}"
                                        alt="{{ $category->category_name }}"></a>
                            </figure>
                            <h5><a href="shop.html">{{ $category->category_name }}</a></h5>
                        </div>
                    @endforeach
                        ...
                        @foreach ($products as $product)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div style="height: 400px;"
                                    class="product-cart-wrap mb-30 d-flex flex-column justify-content-between">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="#">
                                                <img style="object-fit:contain;" class="default-img"
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            @if (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $product->created_at)->addDays(7)->isPast())
                                                <span class="new">New</span>
                                            @elseif(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $product->created_at)->addDays(14)->isPast())
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="product-details.html">{{ substr($product->name, 0, 20) }}</a></h2>
                                        ...
                                        @if (!is_null($product->sales_price) || $product->sales_price !== 0)
                                            <div class="product-price">
                                                <span>GHS. {{ $product->sales_price }} </span>
                                                <span class="old-price">GHS. {{ $product->regular_price }}</span>
                                            </div>
                                        @else
                                            <div class="product-price">
                                                <span>GHS. {{ $product->regular_price }} </span>
                                            </div>
                                        @endif
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-10-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-10-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-11-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-11-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-12-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-12-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-13-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-13-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-14-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-14-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-3-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-4-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-5-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-5-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-6-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-6-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-7-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-8-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-8-2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal"
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-9-1.jpg') }}"
                                                alt="">
                                            <img class="default-img"
    ...
    <section class="section-padding">
        <div class="container wow fadeIn animated">
            <h3 class="section-title mb-20"><span>Popular</span> Products</h3>
            <div class="carausel-6-columns-cover position-relative">
