                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-1-1.jpg') }}"
                                                alt="">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            ...
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-5-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-6-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-6-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/imgs/shop/product-8-1.jpg') }}" alt="">
                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-8-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
        ...
        <div class="container wow fadeIn animated">
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop.html"> <img src="{{ asset('assets/imgs/shop/category-thumb-2.jpg') }}"
                                    alt=""></a>
                        </figure>
                ...
                <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('assets/imgs/shop/product-4-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('assets/imgs/shop/product-4-2.jpg') }}"
                                        alt="">
                                </a>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('assets/imgs/shop/product-15-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('assets/imgs/shop/product-15-2.jpg') }}"
                                        alt="">
                                </a>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('assets/imgs/shop/product-3-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('assets/imgs/shop/product-3-2.jpg') }}"
                                        alt="">
                                </a>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('assets/imgs/shop/product-9-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('assets/imgs/shop/product-9-2.jpg') }}"
                                        alt="">
                                </a>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="product-details.html">
                                    <img class="default-img" src="{{ asset('assets/imgs/shop/product-7-1.jpg') }}"
                                        alt="">
                                    <img class="hover-img" src="{{ asset('assets/imgs/shop/product-7-2.jpg') }}"
                                        alt="">
                                </a>
