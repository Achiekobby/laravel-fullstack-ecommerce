...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        @foreach ($product->photos as $key => $image)
                            <div
                                class="{{ array_key_exists($key, $product->photos) && $key == 'image_one' ? 'carousel-item  active' : 'carousel-item ' }}">
            ...
            <div style="height: 40%;" class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <div class="d-inline-flex">
                            <a @disabled(true) class="text-dark px-2" href="">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("btn-plus").addEventListener("click", incrementQuantity);
        document.getElementById("btn-minus").addEventListener("click", decrementQuantity);
        ...
        function updateButtonState() {
            ...
            btnMinus.disabled = currentValue < 2;
        }
    });
</script>
